                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{  old('sku',$product->sku) }}" placeholder="Enter SKU code">
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number"  value="{{ old('discount_price', $product->discount_price) }}" class="form-control" placeholder="0.00">
                            </div>
